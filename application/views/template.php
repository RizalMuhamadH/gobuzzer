...
<html>
    <head>
        ...
        <!-- select2 -->
        <link rel="stylesheet" href="<?php echo base_url() ?>template/select2/css/select2.min.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- select2 -->
        <script src="<?php echo base_url() ?>template/select2/js/select2.full.min.js"></script>
